...
export default function LandingPage() {
   ...
   return (
      <>
         <Navbar />
         <section
            className="mx-auto min-h-[600px] flex flex-col items-center justify-center"
            style={{
         ...
         >
            <div className="container px-6 py-16 flex flex-col gap-6 lg:items-center lg:text-center lg:justify-center">
               <h1 className="text-[36px] md:text-[52px] lg:max-w-[70%]">
                  Understand Your Taxes. Before They <span className="text-green-100 italic">Understand</span> You.
               </h1>
         ...
         <section id="about" className="pt-[88px] px-6 container mx-auto">
            <div className="flex flex-col lg:flex-row gap-7">
               <div className="w-full lg:w-auto lg:shrink-0">
                  <Image src={LogoSpat} alt="Logo Spat" className="w-full lg:w-auto lg:h-full object-contain" />
               </div>
               <div className="bg-[#EDFFF5] rounded-lg overflow-hidden flex-1 lg:relative py-8 lg:py-0">
                  <p className="text-[30px] lg:text-[130px] text-black lg:text-[#E2F3EA] font-bold lg:absolute lg:bottom-0 lg:right-0 text-center lg:text-left leading-24">
                     ABOUT US
                  </p>
         ...
         <section className="py-[88px] px-6 container mx-auto flex items-center justify-center">
            <div className="max-w-[1200px] w-full bg-[#C8E6D7] rounded-2xl p-8 md:p-16">
               <h1 className="text-[32px] md:text-[42px] mb-12">
                  Join the <span className="italic text-green-100">Waitlist</span> now!
               </h1>
                  ...
                  {inputFields.map((field) => (
                     <div key={field.name} className="flex flex-col gap-3">
                        ...
                        <input
                           ...
                           required
                           className="py-4 px-6 rounded-lg border-2 border-green-100 focus:outline-none focus:border-green-200 transition-colors duration-300"
                        />
                     </div>
                  ))}
         ...
         <Modal
            ...
            title="Thank You!"
            message="You have successfully joined our waitlist. We'll notify you when we launch!"
         />
      </>
   );
}
